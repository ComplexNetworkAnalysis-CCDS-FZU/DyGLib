    ...
    def __init__(
        ...
        *,
        ...
        self.neighbor_co_occurrence_encoder = NeighborCooccurrenceEncoder(
            ...
            module_bte_evidence_gate=module_bte_evidence_gate,
            module_bte_b2_density_norm=module_bte_b2_density_norm,
            module_bte_b3_default_marker=module_bte_b3_default_marker,
            module_bte_b4_channel_gate=module_bte_b4_channel_gate,

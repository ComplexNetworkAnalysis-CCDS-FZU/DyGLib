...
def main() -> int:
    ...
    print()
    g = show("主表 sign WV（NN-40 LF-15, 5 seeds）", "results/main_tables/raw/sign/WikiVote/*.json")
    mean_line("sign WV", g)
    print()
    g = show("主表 linksign WV（NN-15 LF-10, 5 seeds）", "results/main_tables/raw/linksign/WikiVote/*.json")
    mean_line("linksign WV", g)
    print()
    g = show("主表 sign BA（NN-40 LF-15, 5 seeds）", "results/main_tables/raw/sign/BitcoinAlpha/*.json")
    mean_line("sign BA", g)
    print()

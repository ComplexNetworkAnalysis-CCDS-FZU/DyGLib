...
class Data:
    ...
    def __init__(
        ...
        :param node_interact_sign: ndarray sign of interact
        ...
        self.node_interact_sign = node_interact_sign
        self.labels = labels
...
def get_link_prediction_data(
    ...
    *,
    ...
    node_interact_sign = graph_df.sign.values.astype(np.int8)
    ...
    val_data = Data(
        ...
        node_interact_sign=node_interact_sign[val_mask],
    ...
    test_data = Data(
        ...
        node_interact_sign=node_interact_sign[test_mask],
    ...
    new_node_val_data = Data(
        ...
        node_interact_sign=node_interact_sign[new_node_val_mask],
    ...
    new_node_test_data = Data(
        ...
        node_interact_sign=node_interact_sign[new_node_test_mask],

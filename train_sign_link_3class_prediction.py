...
if __name__ == "__main__":
    ...
    train_neighbor_sampler = get_neighbor_sampler(
        ...
        e2_self_recent=args.e2_self_recent,
    )
    ...
    for run,run_seed in enumerate(args.seeds):
        ...
        if args.model_name == "DyGFormer":
            ...
            dynamic_backbone = SignDyGFormer(
                ...
                module_bte_b2_density_norm=args.module_bte_b2_density_norm,
                module_bte_b3_default_marker=args.module_bte_b3_default_marker,
                module_bte_b4_channel_gate=args.module_bte_b4_channel_gate,
